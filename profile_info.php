...
<html>
  ...
  <body>
    ...
    <div class="container-md py-3">
      ...
      <form method="POST" class="row col-11 col-md-9 mx-auto">


        <label class="my-2">Gender:</label>
        <select class="form-control col-9 me-1 input" name="gender" value="<?php echo $row['gender'] ?>">
          <option value="male">Male</option>
          <option value="female">Female</option>
        </select>

        <label class="my-2">Relationship status:</label>
        <select class="form-control col-9 input" name="rel_status" value="<?php echo $row['rel_status'] ?>">
        ...
        <input type="text" class="form-control col-9 input" name="location" value="<?php echo $row['location'] ?>">
